...
I consider myself a backend engineer and Python enthusiast, but I've touched a ton of different things over the years over many different applications.
...
an internal business metrics portal built with Flask + Graphana. The core ad-tech team was Java/Spring services which bid on real-time advertising
spots for tracked users on behalf of our business we ran advertising campaigns for.
...
I still think its fascinating how we build, compose, and deploy the code we write, as it informs the design decisions we make. 
